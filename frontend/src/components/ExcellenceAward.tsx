...
const ExcellenceAward = () => {
  return (
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            {/* Heading */}
            <h2 className="text-4xl md:text-5xl lg:text-5xl font-bold mb-6 text-center sm:text-left leading-tight text-gray-800">
              Fill Your{" "}
            ...
            {/* Description */}
            <p className="text-center sm:text-left text-base md:text-lg text-gray-600 mb-8 leading-relaxed">
              Recognize outstanding achievements in business excellence. Submit
              your nomination for the prestigious AICC Excellence Award and
              celebrate success stories that inspire the business community.
            </p>
    ...
    px-6 py-3 rounded-2xl font-bold text-lg transition-all duration-300 shadow-xl hover:shadow-blue-500/25 transform hover:scale-105 hover:-translate-y-1"
                >
                  <span className="flex items-center space-x-3">
                    <span>Click Here</span>
                    <div className="w-3 h-3 bg-white rounded-full group-hover:animate-ping"></div>
