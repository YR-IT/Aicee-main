      ...
      <div className="max-w-6xl mx-auto px-6 mt-16">
        <div className="bg-white rounded-3xl shadow-xl p-10">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              href="/login"
              className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-2 rounded-lg transition text-sm"
            >
              Login
            </a>
          </div>
        ...
        <div className="mt-12 bg-slate-800 text-white rounded-2xl px-8 py-10 text-center">
