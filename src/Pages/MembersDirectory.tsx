...
const MembersDirectory = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-orange-700 via-orange-500 to-orange-600 py-20 px-4 overflow-hidden">
        {/* Animated Background */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredMembers.map((member) => (
              <div key={member.id} className="group bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 overflow-hidden">
                {/* Member Header */}
                <div className="bg-gradient-to-r from-orange-500 via-orange-500 to-orange-400 p-6 relative overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3">
                    <button className="w-full bg-gradient-to-r from-orange-500 via-orange-500 to-orange-600 hover:from-orange-700 hover:to-red-600 text-white py-3 px-6 rounded-2xl font-bold transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl">
