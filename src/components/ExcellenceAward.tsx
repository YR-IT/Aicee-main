    ...
    <section className="relative py-20 px-4 md:px-8 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            {/* Header Badge */}
            <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-blue-100 to-indigo-100 border border-blue-200 rounded-full px-6 py-3 mb-6">
              <Award className="w-6 h-6 text-blue-600" />
              <span className="text-blue-700 font-bold text-lg">Excellence Award</span>
              <Shield className="w-6 h-6 text-blue-600" />
            </div>

            {/* Heading */}
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-gray-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
              <div className="bg-white/50 backdrop-blur-md rounded-2xl p-6 border border-gray-200 shadow-lg">
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/30 backdrop-blur-xl border border-white/40 rounded-3xl p-8 shadow-2xl">
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center group">
                  <div className="w-24 h-24 bg-gradient-to-br from-blue-300 to-indigo-500 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-2xl">
                ...
                <div className="text-center group">
                  <div className="w-20 h-20 bg-gradient-to-br from-green-300 to-teal-400 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-xl">
