  ...
  return (
    <section className=" relative overflow-hidden bg-gradient-to-br from-slate-100 via-purple-100 to-slate-100 flex flex-col">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-32 right-10 w-64 h-64 bg-blue-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-10 left-1/4 w-56 h-56 bg-pink-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
        <div className="absolute inset-0 opacity-30">
          ...
          <div className="absolute inset-0 bg-gradient-to-l from-transparent via-blue-500/10 to-transparent -skew-y-12 animate-pulse" style={{ animationDelay: '1.5s' }} />
        </div>
        {[...Array(20)].map((_, i) => (
          <div
            key={i}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-5">
            {initiatives.map((initiative) => {
              ...
              return (
                ...
                >
                  <div className={`relative h-16 bg-gradient-to-r ${initiative.gradient} flex items-center justify-center`}>
                    <div className="absolute inset-0 bg-black/10"></div>
                    <div className="relative z-10 flex items-center space-x-2 px-4">
                      <Icon className="w-5 h-5 text-white" />
                      <h3 className="text-white font-semibold text-xs sm:text-sm uppercase">{initiative.title}</h3>
                    </div>
                  </div>
